<template>
    <div class="container ">
    <div class="d-flex justify-center mt-15 outlined" outlined>


      <form enctype="multipart/form-data"  @submit.prevent="sendFile" style="width:600px; height:700px">
            <h2 class="text-center text-uppercase my-10">Upload Inventory CSV File</h2>
          <div v-if="message" :class="`message ${error ? 'text-danger' :'text-success'} `">
          <div class="message-body">
            <p class="red lighten-4 text-center pa-4">{{message}}</p>
          </div>
          </div>
